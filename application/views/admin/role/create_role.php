	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
                        <a href="<?php echo base_url('role-list');?>"><i class="fa fa-fw fa-users"></i><span> App Users </span> </a>
                    </li>
						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left">User - Create Role </h1>
...
<?php echo form_open('save-user-role'); ?>
  <div class="form-group">
    <label for="email">User Role:</label>
    <input type="text"name="userRole" class="form-control" placeholder="user role"value="<?php echo set_value('userRole'); ?>">
  ...
  <button type="submit" class="btn btn-primary btn-sm btn-block">Save</button>
   <a href="<?php echo base_url('role-list');?>" class="btn btn-danger btn-sm btn-block">Back</a>
